...
class TodoApp(ft.Column):
    ...
    def __init__(self):
        ...
        self.items_left = ft.Text(") items left")
        ...
        self.controls = [
            ft.Row(
                [
                    ft.Text(
                        value="To-Dos", theme_style=ft.TextThemeStyle.HEADLINE_MEDIUM
                    )
                ],
            ...
            ft.Row(
                controls=[
                    ...
                    ft.FloatingActionButton(
                        icon=ft.icons.ADD, on_click=self.add_clicked, tooltip="Add Task"
                    ),
                ],
            ),
            ft.Column(
